...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mb-4">
                <i class="fa fa-table mr-2"></i> Tambah Jurusan
            </h1>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            <span class="text-muted">Tambah Jurusan</span>
                        </div>
                        <div class="card-body">

                        
                            <form action="<?php echo base_url().'admin/crudjurusan/tambah_aksi';?>"method="post">
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="id_jurusan" id="id_jurusan" class="form-control" value="<?= $id_jurusan;?>" readonly>
                                        </div>
                                    </div>
                           <div class="form-group">
