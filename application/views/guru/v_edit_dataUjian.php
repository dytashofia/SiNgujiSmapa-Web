...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid ">
            <h1 class="mb-4">
                <i class="fa fa-table mr-2 mt-4"></i>Edit Data Ujian
            </h1>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            <span class="text-muted">Edit Ujian</span>
                        </div>
                        <div class="card-body">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_jenis_soal" id="id_jenis_soal" class="custom-select">
                                            ...
                                            ?>
                                                ...
                                                <option <?php if ($row->id_jenis_soal == $detailJenis->id_jenis_soal) {
                                                            echo "selected";
                                                        }
                                                        ?> value="<?= $detailJenis->id_jenis_soal; ?>"><?= $detailJenis->jenis; ?></option>
                                            <?php
                                            endforeach;
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_tipe" id="id_tipe" class="custom-select">
                                            ...
                                            ?>
                                                <option <?php if ($row->id_tipe == $detailTipe->id_tipe) {
                                                            echo "selected";
                                                        }
                                                        ?> value="<?= $detailTipe->id_tipe; ?>"><?= $detailTipe->tipe_ujian; ?></option>
                                            <?php
                                            endforeach;
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="jumlah_soal" id="jumlah_soal" class="form-control" value="<?= $row->jumlah_soal; ?>" placeholder="Masukkan jumlah soal...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="wkatu_mengerjakan" id="wkatu_mengerjakan" class="form-control" value="<?= $row->waktu_mengerjakan; ?>" placeholder="Masukkan Waktu Mengerjakan...">
                                        <?= form_error('wkatu_mengerjakan', '<small class="text-form text-danger mt-2 ml-2">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="wkatu_mulai"> Waktu Mulai </label>
                                        <input type="number" name="wkatu_mulai" id="wkatu_mulai" class="form-control" value="<?= $row->waktu_mulai; ?>" placeholder="Masukkan Waktu mulai...">
                                        <?= form_error('wkatu_mulai', '<small class="text-form text-danger mt-2 ml-2">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="token_soal"> Token Ujian </label>
                                        <input type="text" name="token_soal" id="token_soal" class="form-control" value="<?= $row->token_soal; ?>" placeholder=" Masukkan TOKEN UJIAN...">
                                        <?= form_error('token_soal', '<small class="text-form text-danger mt-2 ml-2">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="status"> Status</label>
                                        <select name="status" id="status" class="custom-select">
                                            <option <?php echo ($row->status_ujian == 'Aktif') ? "selected" : ''; ?> value="Aktif"> Aktif </option>
                                            <option <?php echo ($row->status_ujian == 'Non - Aktif') ? "selected" : ''; ?> value="Non - Aktif"> Non - Aktif </option>
                                        </select>
                                        <?= form_error('id_tipe', '<small class="text-form text-danger mt-2 ml-2">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
