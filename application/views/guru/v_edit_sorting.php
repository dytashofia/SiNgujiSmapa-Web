    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Input Soal Mengurutkan</li>
            </ol>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                ...
                                <input type="text" name="id_soal" id="id_soal" class="form-control" value="<?=$soal_sorting->id_soal;?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="pertanyaan" id="textarea-ckeditor textarea-pertanyaan" class="form-control ckeditor"><?= $soal_sorting->pertanyaan;?></textarea>
                        ...
                        <label><h5>Kunci Jawaban</h5></label>
                            <div>
                                <textarea id="textarea-ckeditor" name="kunci_jawaban"  class="ckeditor"><?= $soal_sorting->kunci_jawaban;?></textarea></div>
                            </div>
                        </div>        
                        <div class="form-group">
                        <label><h5>Pembahasan</h5></label>
                            <div>
                                <textarea id="textarea-ckeditor" rows="2" name="pembahasan"  class="ckeditor"><?= $soal_sorting->pembahasan;?></textarea></div>
                            </div>
                            <br>
                        <div class="form-group form-actions">
                                <div class="row">
                                    <div class="col-sm-12 col-md-2">
                                        <a href="<?= base_url('soal/'.$soal_sorting->id_paket);?>" class="btn btn-outline-secondary w-100">Kembali</a>
                                     </div>
                                    <div class="col-sm-12 col-md-2">
